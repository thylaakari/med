  ...
  <main>
    <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
      <article class="rounded-xl border-2 border-gray-100 bg-white mb-4">
        ...
        <div class="flex justify-end">
          ...
          >
            ...
            <span class="text-[10px] font-medium sm:text-xs">Успешно!</span>
          </strong>
        </div>
      </article>
      ...
      <article class="rounded-xl border-2 border-gray-100 bg-white mb-4">
        <div class="flex items-start gap-4 p-4 sm:p-6 lg:p-8">
          <div>
            ...
            <div class="mt-2 sm:flex sm:items-center sm:gap-2">
              <div class="flex items-center gap-1 text-gray-500">
                <p class="text-xs">Описано за 3 минуты</p>
              </div>
        ...
        <div class="flex justify-end">
          <strong
            class="-me-[2px] -mb-[2px] inline-flex items-center gap-1 rounded-ss-xl rounded-ee-xl bg-red-600 px-3 py-1.5 text-white"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="size-4"
      ...
      <article class="rounded-xl border-2 border-gray-100 bg-white mb-4">
        ...
        <div class="flex justify-end">
          <strong
            class="-me-[2px] -mb-[2px] inline-flex items-center gap-1 rounded-ss-xl rounded-ee-xl bg-yellow-600 px-3 py-1.5 text-white"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="size-4"
